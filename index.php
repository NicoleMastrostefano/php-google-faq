  ...
  <body>
    <header>
      <div id="header_nav">
        <div id="nav_top">
          <div id="top_left">
            <h3><img src="img/googlelogo.png" alt=""> Privacy e termini</h3>
          </div>
          <div id="top_right">
...
<!-- seconda soluzione: con le <p> (direttamente al secondo livello) per ogni paragrafo nell'array delle risposte (al posto delle virgolette). -->
